        ...
        pogstack.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent evt) {
                if ((evt.getAction() == MotionEvent.ACTION_DOWN)) {
                    if (seekBar.getProgress() >= 0 && seekBar.getProgress() <= 78) {
                    ...
                    } else if (seekBar.getProgress() >= 79 && seekBar.getProgress() <= 166) {
                        Toast.makeText(getApplicationContext(), "HIT! You got a POG", Toast.LENGTH_SHORT).show();
                        Toast.makeText(getApplicationContext(), "Enemy's Turn", Toast.LENGTH_SHORT).show();
                    } else if (seekBar.getProgress() >= 167 && seekBar.getProgress() <= 200) {
                        Toast.makeText(getApplicationContext(), "SLAM! You got a POG", Toast.LENGTH_SHORT).show();
                        Toast.makeText(getApplicationContext(), "You take another turn!", Toast.LENGTH_SHORT).show();
                    }
